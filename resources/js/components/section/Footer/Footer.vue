<template>
    <footer class="overflow-hidden">
        <div
            class="relative bg-[linear-gradient(115deg,var(--tw-gradient-stops))]
            from-[#fff1be] from-[28%] via-[#ee87cb] via-[70%] to-[#b060ff]
            sm:bg-[linear-gradient(145deg,var(--tw-gradient-stops))]"
        >
            <div class="absolute inset-2 rounded-2xl bg-white/80"></div>
                ...
                <div class="mx-auto max-w-2xl lg:max-w-7xl">
                    <div class="relative pb-16 pt-20 text-center sm:py-24">
                        <hgroup><h2
                            ...
                            Get started</h2>
                            <p class="mt-6 text-3xl font-medium tracking-tight text-gray-950 sm:text-5xl">Ready to dive
                                in?<br>Start your free trial today.</p></hgroup>
                        <p class="mx-auto mt-6 max-w-xs text-sm/6 text-gray-500">Get the cheat codes for selling and
                            unlock your team's revenue potential.</p>
                        <div class="mt-6"><a
                            ...
                            data-headlessui-state="" href="#">Get started</a></div>
                    </div>
                    <div class="pb-16">
                        <div
                        ...
                        <div
                            ...
                            <div>
                                <div class="py-3 group/item relative">
                                    ...
                                    <div class="text-sm/6 text-gray-950">© 2024 Radiant Inc.</div>
                                </div>
                            </div>
                            <div class="flex">
                                <div class="flex items-center gap-8 py-3 group/item relative">
                                    ...
                                    <a target="_blank" aria-label="Visit us on Facebook"
                                       class="text-gray-950 data-[hover]:text-gray-950/75" data-headlessui-state=""
                                       href="https://facebook.com">
                                        <svg viewBox="0 0 16 16" fill="currentColor" class="size-4">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M16 8.05C16 3.603 12.418 0 8 0S0 3.604 0 8.05c0 4.016 2.926 7.346 6.75 7.95v-5.624H4.718V8.05H6.75V6.276c0-2.017 1.194-3.131 3.022-3.131.875 0 1.79.157 1.79.157v1.98h-1.008c-.994 0-1.304.62-1.304 1.257v1.51h2.219l-.355 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.95z"></path>
                                        </svg>
                                    </a><a target="_blank" aria-label="Visit us on X"
                                           class="text-gray-950 data-[hover]:text-gray-950/75" data-headlessui-state=""
                                           href="https://x.com">
                                    <svg viewBox="0 0 16 16" fill="currentColor" class="size-4">
                                        <path
                                ...
                                </a><a target="_blank" aria-label="Visit us on LinkedIn"
                                       class="text-gray-950 data-[hover]:text-gray-950/75" data-headlessui-state=""
