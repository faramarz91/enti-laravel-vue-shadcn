<template>
    <div class="backdrop-blur z-10">
        ...
        <TransitionRoot as="template" :show="open">
            <Dialog class="relative z-40 lg:hidden" @close="open = false">
                ...
                <div class="fixed inset-0 z-40 flex">
                    <TransitionChild as="template"
                                     enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full"
        ...
        <header class="relative bg-white bg-opacity-20 z-10">
            <p v-if="topSloganMessage" class="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">{{topSloganMessage}}</p>

            <nav aria-label="Top" class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-50">
                <div class="border-b  border-gray-300">
                    <div class="flex h-16 items-center">
                        <button type="button" class="relative rounded-md bg-white z-10 p-2 text-gray-400 lg:hidden" @click="open = true">
                            <span class="absolute -inset-0.5" />
                        ...
                        <!-- Logo -->
                        <div class="ml-4 flex lg:ml-0 z-20">
                            <a href="/">
                                <span class="sr-only">Enti Otomasyon</span>
                        ...
                        <PopoverGroup class="hidden lg:ml-8 lg:block lg:self-stretch">
                            <div class="flex h-full space-x-8 z-10">
                                <RouterLink v-for="page in navigation.pages" :key="page.name" to="#" class="z-10 flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">{{ page.name }}</RouterLink>
                                <Popover v-for="category in navigation.categories" :key="category.name" class="flex" v-slot="{ open }">
                                    <div class="relative flex">
                                        <PopoverButton :class="[open ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-700 hover:text-gray-800',
...
<!--                            <div class="flex lg:ml-6">
                                <a href="#" class="p-2 text-gray-400 hover:text-gray-500 mr-5">
...
<!--                            <div class="hs-tooltip inline-block">
                        ...
                        &lt;!&ndash;        <img class="inline-block size-[46px] rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="Avatar">&ndash;&gt;
                                    <BookmarkIcon class="size-6 shrink-0 text-gray-400 group-hover:text-gray-500" aria-hidden="true" />
                                    <span class="absolute top-0 end-0 block size-2 rounded-full ring-2 ring-white bg-red-500 dark:ring-neutral-900"></span>
...
import { Bars3Icon, MagnifyingGlassIcon, BookmarkIcon, XMarkIcon } from '@heroicons/vue/24/outline'
